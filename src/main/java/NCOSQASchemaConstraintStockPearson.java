...
public class NCOSQASchemaConstraintStockPearson {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQASchemaConstraintStockPearson.class);
        Properties props = new Properties();
        String appID = UUID.randomUUID().toString();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "stock-schema-pearson-"+appID);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-stock-schema-pearson");
        ...
        AnnKStream<String, Stock> annotatedKStream = AnnKStream.annotateSchemaNotWindowed(builder
                ...
                }, Topology.AutoOffsetReset.EARLIEST)), new SchemaConstraintStockValueFactory(), applicationSupplier, props);
