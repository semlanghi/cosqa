...
public class KCOSQAPKLinearRoad {
    public static void main(String[] args){

        Logger logger = LoggerFactory.getLogger(KCOSQAPKLinearRoad.class);
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "kcosqa-linearroad-pk");
        ...
        ConstraintFactory<ValueAndTimestamp<SpeedEvent>> speedConstraintSpeedEventValueFactory = new PKLinearRoadValueFactory();
