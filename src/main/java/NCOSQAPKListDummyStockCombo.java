...
public class NCOSQAPKListDummyStockCombo {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAPKListDummyStockCombo.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-stock-list-combo-pk");
        ...
        AnnKStream<String, Stock> annotatedKStream = AnnKStream.annotateListNotWindowed(builder
