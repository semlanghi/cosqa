 ...
 */
public class SpeedConstraintGPSValueFactoryWithDescriptionY implements ConstraintFactory<ValueAndTimestamp<GPS>> {

    private final double maxCoefficient;
    private final double minCoefficient;
    private final String description;

    public SpeedConstraintGPSValueFactoryWithDescriptionY(String description, double maxCoefficient, double minCoefficient) {
