...
public class PerformanceInputInconsistencyTransformerOnlyValues<Kin, Vin> implements ValueTransformer<ConsistencyAnnotatedRecord<Vin>, ConsistencyAnnotatedRecord<Vin>> {
    ...
    public PerformanceInputInconsistencyTransformerOnlyValues(ApplicationSupplier shutdownHook, Properties properties) {
    ...
    @Override
    public ConsistencyAnnotatedRecord<Vin> transform(ConsistencyAnnotatedRecord<Vin> value) {
        count++;
        try {
