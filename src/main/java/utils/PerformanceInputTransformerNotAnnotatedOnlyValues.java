...
public class PerformanceInputTransformerNotAnnotatedOnlyValues<Vin> implements ValueTransformer<Vin, Vin> {
    ...
    public PerformanceInputTransformerNotAnnotatedOnlyValues(ApplicationSupplier shutdownHook, Properties properties) {
    ...
    @Override
    public Vin transform(Vin value) {
        try {
