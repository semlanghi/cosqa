...
public class PerformanceProcessorNI<Kin, Vin> implements Processor<Kin, Vin, Void, Void> {
    ...
    public PerformanceProcessorNI(ApplicationSupplier shutdownHook, Properties properties) {
