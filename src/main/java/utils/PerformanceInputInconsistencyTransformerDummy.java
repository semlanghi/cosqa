...
public class PerformanceInputInconsistencyTransformerDummy<Kin, Vin> implements Transformer<Kin, ConsistencyAnnotatedRecord<Vin>, KeyValue<Kin, ConsistencyAnnotatedRecord<Vin>>> {
    ...
    public PerformanceInputInconsistencyTransformerDummy(ApplicationSupplier shutdownHook, Properties properties) {
    ...
    public void init(org.apache.kafka.streams.processor.ProcessorContext context) {
        ...
        file = new File(performanceFileDirectory+ "input-inconsistency-"+ resultFileSuffix +"-dummy.csv");
