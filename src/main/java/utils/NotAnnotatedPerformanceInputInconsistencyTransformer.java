...
public class NotAnnotatedPerformanceInputInconsistencyTransformer<Kin, Vin> implements Transformer<Kin, Vin, KeyValue<Kin, Vin>> {
    ...
    public NotAnnotatedPerformanceInputInconsistencyTransformer(ApplicationSupplier shutdownHook, Properties properties) {
