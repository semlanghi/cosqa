...
public class DummyNCOSQAGraphLinearRoad {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(DummyNCOSQAGraphLinearRoad.class);
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "dummy-ncosqa-linearroad-graph");
        ...
        AnnKStream<Long, SpeedEvent> annotatedKStream = AnnKStream.annotateGraphListNotWindowed(builder
