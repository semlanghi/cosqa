...
public class NCOSQAPKListDummyGPS {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAPKListDummyGPS.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-gps-list-pk");
        ...
        AnnKStream<String, GPS> annotatedKStream = AnnKStream.annotateListNotWindowed(builder
