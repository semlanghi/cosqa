...
public class ConsistencyAnnotatorMultiConstraintFIlter<K, Vin> implements Transformer<K,Vin, KeyValue<K, ConsistencyAnnotatedRecord<ValueAndTimestamp<Vin>>>> {
    ...
    public ConsistencyAnnotatorMultiConstraintFIlter(String storeName, String storeName2, long windowSize, long windowSlide) {
    ...
    public KeyValue<K, ConsistencyAnnotatedRecord<ValueAndTimestamp<Vin>>> transform(K key, Vin value) {
        ...
        if (consistencyAnnotatedRecord3.getPolynomial().degree()==0)
