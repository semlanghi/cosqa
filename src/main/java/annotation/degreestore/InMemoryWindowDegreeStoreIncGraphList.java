...
public class InMemoryWindowDegreeStoreIncGraphList<K,V> implements InMemoryWindowDegreeStore<K,V> {

    private final Logger logger = LoggerFactory.getLogger(InMemoryWindowDegreeStoreIncGraphList.class);
    ...
    public InMemoryWindowDegreeStoreIncGraphList(String name, long windowSize, long windowSlide, ConstraintFactory<ValueAndTimestamp<V>> constraintFactory) {
        this.name = name;
    ...
    public void put(K key, ConsistencyAnnotatedRecord<ValueAndTimestamp<V>> value, long windowEndTimestamp) {
        ...
        do {
            ...
            windows.computeIfAbsent(windowed, k -> new InconsistencyGraphList<>(this.constraintFactory));
