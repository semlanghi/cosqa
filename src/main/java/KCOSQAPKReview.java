...
public class KCOSQAPKReview {
    public static void main(String[] args){

        Logger logger = LoggerFactory.getLogger(KCOSQAPKReview.class);
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "kcosqa-review-pk");
        ...
        ConstraintFactory<ValueAndTimestamp<Review>> speedConstraintReviewValueFactory = new PKReviewValueFactory();
