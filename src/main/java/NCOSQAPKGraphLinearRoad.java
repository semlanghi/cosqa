...
import linearroad.PKLinearRoadValueFactory;
...
public class NCOSQAPKGraphLinearRoad {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAPKGraphLinearRoad.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        AnnKStream<Long, SpeedEvent> annotatedKStream = AnnKStream.annotateIncGraphListNotWindowed(builder
                ...
                }, Topology.AutoOffsetReset.EARLIEST)), timeWindows.size(), timeWindows.advanceMs, new PKLinearRoadValueFactory(), applicationSupplier, props);
