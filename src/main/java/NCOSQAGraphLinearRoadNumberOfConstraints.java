...
public class NCOSQAGraphLinearRoadNumberOfConstraints {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAGraphLinearRoadNumberOfConstraints.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-linearroad-graph-ncons");
        ...
        AnnKStream<Long, SpeedEvent> annotatedKStream = AnnKStream.annotateGraphListNotWindowedNotAlways(builder
