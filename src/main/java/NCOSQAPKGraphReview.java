...
import reviews.PKReviewValueFactory;
...
public class NCOSQAPKGraphReview {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAPKGraphReview.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-review-graph-pk");
        ...
        AnnKStream<String, Review> annotatedKStream = AnnKStream.annotateIncGraphListNotWindowed(builder
                ...
                }, Topology.AutoOffsetReset.EARLIEST)), timeWindows.size(), timeWindows.advanceMs, new PKReviewValueFactory(), applicationSupplier, props);
