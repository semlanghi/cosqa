...
public class KCOSQAStockCombo {
    public static void main(String[] args){

        Logger logger = LoggerFactory.getLogger(KCOSQAStockCombo.class);
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "kcosqa-stock-combo");
