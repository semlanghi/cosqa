...
public class DummyFilterOutGraphGPS {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(DummyFilterOutGraphGPS.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "dummy-filterout-gps");
        ...
        KStream<String, GPS> annotatedKStream = AnnKStream.annotateGraphListFilter(builder
