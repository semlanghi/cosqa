...
public class NCOSQASchemaConstraintDummyLinearRoad {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQASchemaConstraintDummyLinearRoad.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "dummy-ncosqa-linearroad-schema");
        ...
        AnnKStream<Long, SpeedEvent> annotatedKStream = AnnKStream.annotateSchemaNotWindowed(builder
                ...
                }, Topology.AutoOffsetReset.EARLIEST)), new SchemaConstraintLinearRoadValueFactory(), applicationSupplier, props);
