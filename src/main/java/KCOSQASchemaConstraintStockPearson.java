...
public class KCOSQASchemaConstraintStockPearson {
    public static void main(String[] args){

        Logger logger = LoggerFactory.getLogger(KCOSQASchemaConstraintStockPearson.class);
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "kcosqa-stock-pearson-schema");
