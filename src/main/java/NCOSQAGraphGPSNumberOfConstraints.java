...
public class NCOSQAGraphGPSNumberOfConstraints {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAGraphGPSNumberOfConstraints.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-gps-graph-ncons");
        ...
        AnnKStream<String, GPS> annotatedKStream = AnnKStream.annotateGraphListNotWindowedNotAlways(builder
