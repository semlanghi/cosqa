...
public class NCOSQASchemaConstraintDummyReview {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQASchemaConstraintDummyReview.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "dummy-ncosqa-review-schema");
        ...
        AnnKStream<String, Review> annotatedKStream = AnnKStream.annotateSchemaNotWindowed(builder
                ...
                }, Topology.AutoOffsetReset.EARLIEST)), new SchemaConstraintReviewValueFactory(), applicationSupplier, props);
