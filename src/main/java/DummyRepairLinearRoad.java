...
public class DummyRepairLinearRoad {

    public static void main(String[] args) {


        Logger logger = LoggerFactory.getLogger(DummyRepairLinearRoad.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "dummy-songrepair-linearroad");
        ...
        builder.stream(topic, Consumed.with(Serdes.String(), SpeedEventSerde.instance(), new TimestampExtractor() {
                            @Override
                            public long extract(ConsumerRecord<Object, Object> record, long partitionTime) {
                                return ((SpeedEvent)record.value()).getTimestamp();
                            }
                        }, Topology.AutoOffsetReset.EARLIEST))
                        .transform(new TransformerSupplier<String, SpeedEvent, KeyValue<String, SpeedEvent>>() {
                            @Override
                            public Transformer<String, SpeedEvent, KeyValue<String, SpeedEvent>> get() {
...
//                .process(new ProcessorSupplier<String, SpeedEvent, Void, Void>() {
//                    @Override
//                    public Processor<String, SpeedEvent, Void, Void> get() {
//                        return new Processor<String, SpeedEvent, Void, Void>() {
//                            @Override
//                            public void process(Record<String, SpeedEvent> record) {
