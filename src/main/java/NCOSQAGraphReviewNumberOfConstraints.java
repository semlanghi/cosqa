...
public class NCOSQAGraphReviewNumberOfConstraints {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAGraphReviewNumberOfConstraints.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-review-graph-ncons");
        ...
        AnnKStream<String, Review> annotatedKStream = AnnKStream.annotateGraphListNotWindowedNotAlways(builder
