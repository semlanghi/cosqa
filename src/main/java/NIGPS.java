...
public class NIGPS {
    ...
    public static void main(String[] args) {
        ...
        Logger logger = LoggerFactory.getLogger(NIGPS.class);
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ni-gps");
        ...
        Ranker<GPS> ranker = new RandomGPSRanker(3, Ranker.Order.ASCENDING);

//        annotatedKStream.process(new ProcessorSupplier<String, GPS, Void, Void>() {
//            @Override
