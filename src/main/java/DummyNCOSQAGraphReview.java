...
public class DummyNCOSQAGraphReview {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(DummyNCOSQAGraphReview.class);
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "dummy-ncosqa-review-graph");
        ...
        AnnKStream<String, Review> annotatedKStream = AnnKStream.annotateGraphListNotWindowed(builder
