...
public class NCOSQAListReviewNumberOfConstraints {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAListReviewNumberOfConstraints.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-review-list-ncons");
        ...
        AnnKStream<String, Review> annotatedKStream = AnnKStream.annotateListNotWindowedNotAlways(builder
