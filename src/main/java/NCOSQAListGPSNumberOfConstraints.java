...
public class NCOSQAListGPSNumberOfConstraints {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAListGPSNumberOfConstraints.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-gps-list-ncons");
        ...
        AnnKStream<String, GPS> annotatedKStream = AnnKStream.annotateListNotWindowedNotAlways(builder
