...
public class NCOSQAPKGraphStockCombo {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAPKGraphStockCombo.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-stock-graph-combo-pk");
        ...
        AnnKStream<String, Stock> annotatedKStream = AnnKStream.annotateIncGraphListNotWindowed(builder
                ...
                }, Topology.AutoOffsetReset.EARLIEST)), timeWindows.size(), timeWindows.advanceMs, new PKStockValueFactory(), applicationSupplier, props);
