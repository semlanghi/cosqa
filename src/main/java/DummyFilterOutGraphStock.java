...
public class DummyFilterOutGraphStock {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(DummyFilterOutGraphStock.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "dummy-filterout-stock");
        ...
        KStream<String, Stock> annotatedKStream = AnnKStream.annotateGraphListFilter(builder
