...
public class NCOSQAListLinearRoadNumberOfConstraints {

    public static void main(String[] args) {

        Logger logger = LoggerFactory.getLogger(NCOSQAListLinearRoadNumberOfConstraints.class);
...
//        props.put(StreamsConfig.topicPrefix(TopicConfig.RETENTION_MS_CONFIG), Duration.ofDays(10).toMillis());
        ...
        props.put(ExperimentConfig.RESULT_FILE_SUFFIX, "ncosqa-linearroad-list-ncons");
        ...
        AnnKStream<Long, SpeedEvent> annotatedKStream = AnnKStream.annotateListNotWindowedNotAlways(builder
